...
b1 = Beer.create(:name => "James Boag's Premium", :style => "Lager", :info => "James Boag's Premium is a brand of Tasmanian beer from Boag's Brewery and was first released in 1994. It is a European style lager brewed using pilsner malts and fermented at a lower temperature than most Australian lagers, employing an extended maturation period. It is drier than Cascade Premium Lager, although very similar. It currently has an ABV of 5.0%. It was originally 5.2%.", :rating => 1, :year => 1994, :abv => 5.0, :image => 'http://www.beersofeurope.co.uk/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/pimages/JamesBoags.jpg')
